package com.wsm.comlib.service;
    ...
    private final BroadcastReceiver usbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context arg0, Intent arg1) {
            if (arg1.getAction().equals(ACTION_USB_PERMISSION)) {
                boolean granted = arg1.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false) || (arg1.getExtras() != null && arg1.getExtras().getBoolean(UsbManager.EXTRA_PERMISSION_GRANTED));
                ...
                } else // User not accepted our USB connection. Send an Intent to the Main Activity
                {
                    ...
                    Log.d(TAG, "UsbService: ACTION_USB_PERMISSION_NOT_GRANTED");
                ...
                Log.d(TAG, "UsbService: ACTION_USB_DISCONNECTED");
                if (serialPortConnected) {
                    serialPort.close();
                }
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            if (keep) {
                ...
                Log.d(TAG, "findSerialPortDevice: ACTION_NO_USB");
        ...
        public void run() {
            ...
            if (serialPort != null) {
                if (serialPort.open()) {
                    ...
                    context.sendBroadcast(intent);
                    Log.d(TAG, "UsbService: ACTION_USB_READY");
                } else {
